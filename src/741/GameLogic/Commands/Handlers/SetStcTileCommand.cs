...
public class SetStcTileCommand : ICommand
{
    public void Execute(CommandContext context, string[] args)
    {
        if (args.Length < 3)
        {
            throw new ArgumentException("Usage: set_stc_tile <x> <y> <tileId>");
        }
        ...
        context.MapTiles[context.CurrentMap][x, y].StaticTileId = tileId;
    }
